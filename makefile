...
test_vector: $(TEST_DIR)/redo_test_vector

$(TEST_DIR)/redo_test_vector: $(STUDENT_DIR)/redo_vector.cpp $(TEST_DIR)/redo_test_vector.cpp
...
tests: test_hello test_basics test_pointers test_complex redo_test_vector test_llist
		tests/test_hello
		tests/test_basics
		tests/test_pointers
		tests/test_complex
		tests/redo_test_vector
		tests/test_llist
